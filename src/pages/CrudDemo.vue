			...
			<div class="card">
				...
				<Toolbar class="p-mb-4">
					...
					<template v-slot:right>
						<Button label="Delete" icon="pi pi-trash" class="p-button-danger p-mr-2 p-mb-2" @click="confirmDeleteSelected" :disabled="!selectedProducts || !selectedProducts.length" />
				...
				<Dialog v-model:visible="deleteProductDialog" :style="{width: '450px'}" header="Mensagem de Confirmação!" :modal="true">
					<div class="confirmation-content">
						<i class="pi pi-exclamation-triangle p-mr-3" style="font-size: 2rem" />
						<span v-if="product">Tem certeza de que deseja excluir o registro <b>{{product.name}}</b>?</span>
					</div>
					<template #footer>
				...
				<Dialog v-model:visible="deleteProductsDialog" :style="{width: '450px'}" header="Mensagem de Confirmação!" :modal="true">
					<div class="confirmation-content">
						<i class="pi pi-exclamation-triangle p-mr-3" style="font-size: 2rem" />
						<span v-if="product">Tem certeza de que deseja excluir os registros selecionados ?</span>
					</div>
					<template #footer>
...
export default {
	...
	methods: {
		...
		saveProduct() {
			...
			if (this.product.name.trim()) {
				if (this.product.id) {
					...
					this.$toast.add({severity:'success', summary: 'Sucesso', detail: 'Registro Atualizado!', life: 3000});
				}
				else {
					...
					this.$toast.add({severity:'success', summary: 'Sucesso!', detail: 'Registro Cadastrado!', life: 3000});
				}
		...
		deleteProduct() {
			...
			this.product = {};
			this.$toast.add({severity:'success', summary: 'Sucesso!', detail: 'Registro Deletado.', life: 3000});
		},
		findIndexById(id) {
			let index = -1;
